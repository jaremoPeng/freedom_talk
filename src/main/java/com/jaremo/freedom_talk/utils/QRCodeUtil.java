...
public class QRCodeUtil {
	...
	public QRCodeUtil(Color borderColor, int logoPart) {
	 ...
	 */
	public static void addLogo_QRCode(File qrPic, File logoPic, QRCodeUtil creatrQrCode) {
		try {
	...
	public void createLogoQrCode(String qrcPath,String content,int width,int height,String logoPath){
		...
		//在二维码中加入图片
		QRCodeUtil creatrQrCode = new QRCodeUtil();
